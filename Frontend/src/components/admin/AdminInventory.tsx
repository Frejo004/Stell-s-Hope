          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                ...
                <span className="font-medium">{Math.min(startIndex + itemsPerPage, filteredInventory.length)}</span> sur{' '}
                <span className="font-medium">{filteredInventory.length}</span> produits
              </p>
            </div>
            <div>
